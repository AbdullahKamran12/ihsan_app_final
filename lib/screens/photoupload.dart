...
class _PhotoUploadPageState extends State<PhotoUploadPage> {
  ...
  String getPrompt() {
    String basePrompt =
        ...
        'Especially any time at Dhuhr, Asr, Maghrib, Isha. make sure they are in 24h format. '
        'If there is a sunset column and a maghrib jamaat or adhan column, ignore sunset and take the other one for maghrib. '
        'Each object must have these exact keys:\n'
        '  day (integer 1-31),\n'
        '  fajr_begin   — use the "Fajr Start" or "Fajr Begin" or "Fajr column. '
        'IGNORE any column labelled "Sehri" or "Seheri" or "Suhoor" or any of the like completely,\n'
        '  fajr_jamaat, sunrise,\n'
