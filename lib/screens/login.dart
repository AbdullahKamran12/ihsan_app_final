...
import 'package:ihsan_app_final/screens/signup.dart';
...
class _LoginPageState extends State<LoginPage> {
              ...
              children: [
                ...
                if (!sent) ...[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 252, 243, 210),
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'If you don\'t see the email in your inbox, check your spam or junk folder — it most likely ended up there.',
                            style: TextStyle(
                                fontSize: 12,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: navy,
      // No AppBar — full immersive login
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            children: [
              // ── TOP NAVY BRANDING SECTION ──────────────────────────
              Container(
                width: double.infinity,
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(
                                    color: skyBlue.withOpacity(0.4), width: 1),
                                boxShadow: [
                                  BoxShadow(
                                    color: navy.withOpacity(0.05),
                                    blurRadius: 6,
  ...
  Widget _loginField({
    ...
    required Color navy,
      ...
      TextField(
        ...
        style: const TextStyle(
            fontSize: 15, color: Color.fromARGB(255, 15, 30, 65)),
        decoration: InputDecoration(
          labelText: label,
          labelStyle: const TextStyle(
              color: Color.fromARGB(255, 90, 115, 160), fontSize: 13),
          prefixIcon: Icon(icon,
              color: const Color.fromARGB(255, 10, 25, 60), size: 20),
          filled: true,
          fillColor: white,
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
